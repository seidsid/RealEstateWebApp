...
builder.Services.AddIdentity<AppUser, IdentityRole>().AddEntityFrameworkStores<NurDbContext>().AddDefaultTokenProviders();
...
app.MapControllerRoute(
    name: "default",
    pattern: "{controller=Property}/{action=DisplayProperty}/{id?}");
